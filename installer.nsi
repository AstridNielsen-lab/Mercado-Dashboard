; Mercado Neural - Instalador NSIS
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "assets\images\welcome.bmp"
...
Section "Mercado Neural (obrigatório)" SecMain
    ...
    File "dist\mercado-neural-portable\*.txt"
    File "dist\mercado-neural-portable\version"
    File "dist\mercado-neural-portable\LICENSE"
    ...
    File /r "dist\mercado-neural-portable\components"
    File /r "dist\mercado-neural-portable\config"
    File /r "dist\mercado-neural-portable\electron"
    
    ; Criar atalho no menu iniciar
    CreateDirectory "$SMPROGRAMS\${APPNAME}"
    CreateShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\Mercado-Neural.exe" "" "$INSTDIR\assets\images\icon.ico"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\assets\images\icon.ico"
...
Section "Atalho na Área de Trabalho" SecDesktop
    CreateShortCut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\Mercado-Neural.exe" "" "$INSTDIR\assets\images\icon.ico"
SectionEnd
